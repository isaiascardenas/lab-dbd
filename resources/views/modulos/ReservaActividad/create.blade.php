	...
	<form method="post" action="{{ action('ReservaActividad\ActividadesController@store') }}">
        ...
        <div class="col">
            ...
            <div class="input-group">
                <input type="text" id="fecha_ida" name="fecha_inicio" class="form-control text-center datepicker" readonly="readonly">
        ...
        <div class="col">
            ...
            <div class="input-group">
                <input type="text" id="fecha_vuelta" name="fecha_termino" class="form-control text-center datepicker fecha_termino" readonly="readonly">
                <span class="input-group-append">
                    <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                </span>
            </div>
